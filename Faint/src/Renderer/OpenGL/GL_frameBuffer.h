...
namespace Moon {
    ...
    public:
        ...
        FrameBuffer(const char* name, const glm::ivec2& resolution);
        ~FrameBuffer();
        ...
        void BindDepthAttachmentFrom(const FrameBuffer& srcFrameBuffer);
        void Bind() const;
        void SetViewport();
        ...
        void BlitToBackBuffer(const char* srcName, uint16_t backBufferWidth, uint16_t backBufferHeight);
