...
namespace Faint {
    ...
    void FrameBuffer::CreateAttachment(const char* name, GLenum internalFormat, GLenum minFilter, GLenum magFilter) {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, internalFormat, m_width, m_height, 0, colorAttachment.format, colorAttachment.type, 0);
    ...
    void FrameBuffer::Resize(int width, int height) {
        ...
        for (size_t i = 0; i < m_colorAttachments.size(); ++i) {
            ...
            glGenTextures(1, &colorAttachment.id);
            glBindTexture(GL_TEXTURE_2D, colorAttachment.id);
            glTexImage2D(GL_TEXTURE_2D, 0, colorAttachment.internalFormat, m_width, m_height, 0, colorAttachment.format, colorAttachment.type, 0);
        ...
        //    glGenTextures(1, &m_depthAttachment.id);
        //    glBindTexture(GL_TEXTURE_2D, m_depthAttachment.id);
        //    glTexImage2D(GL_TEXTURE_2D, 0, m_depthAttachment.internalFormat, m_width, m_height, 0, GL_DEPTH_COMPONENT, GL_UNSIGNED_BYTE, 0);
        //    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
        //    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
        //    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
        //    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
