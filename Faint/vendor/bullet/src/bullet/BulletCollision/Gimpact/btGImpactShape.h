...
public:
	...
	SIMD_FORCE_INLINE void setVertices(
		const btVec3& v0, const btVec3& v1,
		const btVec3& v2, const btVec3& v3)
	{
		m_vertices[0] = v0;
		m_vertices[1] = v1;
		m_vertices[2] = v2;
...
public:
    ...
    */
	void getAabb(const btTransform& t, btVec3& aabbMin, btVec3& aabbMax) const
	{
	...
	*/
	virtual void setLocalScaling(const btVec3& scaling)
	{
		localScaling = scaling;
		postUpdate();
	}

	virtual const btVec3& getLocalScaling() const
	{
		return localScaling;
	}
	...
	/*!
    */
	virtual void getChildAabb(int child_index, const btTransform& t, btVec3& aabbMin, btVec3& aabbMax) const
	{
		btAABB child_aabb;
	...
	*/
	...
	virtual void rayTest(const btVec3& rayFrom, const btVec3& rayTo, btCollisionWorld::RayResultCallback& resultCallback) const
	{
		(void)rayFrom;
		(void)rayTo;
		(void)resultCallback;
	...
	*/
	virtual void processAllTriangles(btTriangleCallback* callback, const btVec3& aabbMin, const btVec3& aabbMax) const
	{
		(void)callback;
		(void)aabbMin;
		(void)aabbMax;
	...
	It gives the triangles in local space
	*/
	virtual void processAllTrianglesRay(btTriangleCallback* /*callback*/, const btVec3& /*rayFrom*/, const btVec3& /*rayTo*/) const
	{
	}
...
public:
	...
	*/
	...
	virtual void calculateLocalInertia(btScalar mass, btVec3& inertia) const;
...
public:
	...
	*/
	...
	public:
		...
		SIMD_FORCE_INLINE void get_vertex(unsigned int vertex_index, btVec3& vertex) const
		{
			if (type == PHY_DOUBLE)
			{
...
public:
	...
	*/
	...
	SIMD_FORCE_INLINE void getVertex(int vertex_index, btVec3& vertex) const
	{
...
struct btGImpactMeshShapeData
{
	...
	btVec3FloatData m_localScaling;
