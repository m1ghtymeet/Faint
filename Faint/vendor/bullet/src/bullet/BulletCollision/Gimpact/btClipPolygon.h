...
SIMD_FORCE_INLINE btScalar bt_distance_point_plane(const btVector4 &plane, const btVec3 &point)
{
...
SIMD_FORCE_INLINE void bt_vec_blend(btVec3 &vr, const btVec3 &va, const btVec3 &vb, btScalar blend_factor)
{
...
SIMD_FORCE_INLINE int bt_plane_clip_triangle(
	...
	const btVec3 &point1,
	const btVec3 &point2,
	btVec3 *clipped  // an allocated array of 16 points at least
)
{
	int clipped_count = 0;
