...
double estimateSDFError(const BitmapConstRef<float, 1> &sdf, const Shape &shape, const Vec2 &scale, const Vec2 &translate, int scanlinesPerRow, FillRule fillRule) {
    return estimateSDFError(sdf, shape, Projection(scale, translate), scanlinesPerRow, fillRule);
}

double estimateSDFError(const BitmapConstRef<float, 3> &sdf, const Shape &shape, const Vec2 &scale, const Vec2 &translate, int scanlinesPerRow, FillRule fillRule) {
    return estimateSDFError(sdf, shape, Projection(scale, translate), scanlinesPerRow, fillRule);
}

double estimateSDFError(const BitmapConstRef<float, 4> &sdf, const Shape &shape, const Vec2 &scale, const Vec2 &translate, int scanlinesPerRow, FillRule fillRule) {
    return estimateSDFError(sdf, shape, Projection(scale, translate), scanlinesPerRow, fillRule);
}
