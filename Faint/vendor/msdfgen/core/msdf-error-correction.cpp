...
template <int N>
static void msdfErrorCorrectionInner_legacy(const BitmapRef<float, N> &output, const Vec2 &threshold) {
...
void msdfErrorCorrection_legacy(const BitmapRef<float, 3> &output, const Vec2 &threshold) {
    msdfErrorCorrectionInner_legacy(output, threshold);
}
void msdfErrorCorrection_legacy(const BitmapRef<float, 4> &output, const Vec2 &threshold) {
    msdfErrorCorrectionInner_legacy(output, threshold);
}
