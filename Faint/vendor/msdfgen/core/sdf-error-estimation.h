...
void scanlineSDF(Scanline &line, const BitmapConstRef<float, 1> &sdf, const Vec2 &scale, const Vec2 &translate, bool inverseYAxis, double y);
void scanlineSDF(Scanline &line, const BitmapConstRef<float, 3> &sdf, const Vec2 &scale, const Vec2 &translate, bool inverseYAxis, double y);
void scanlineSDF(Scanline &line, const BitmapConstRef<float, 4> &sdf, const Vec2 &scale, const Vec2 &translate, bool inverseYAxis, double y);
double estimateSDFError(const BitmapConstRef<float, 1> &sdf, const Shape &shape, const Vec2 &scale, const Vec2 &translate, int scanlinesPerRow, FillRule fillRule = FILL_NONZERO);
double estimateSDFError(const BitmapConstRef<float, 3> &sdf, const Shape &shape, const Vec2 &scale, const Vec2 &translate, int scanlinesPerRow, FillRule fillRule = FILL_NONZERO);
double estimateSDFError(const BitmapConstRef<float, 4> &sdf, const Shape &shape, const Vec2 &scale, const Vec2 &translate, int scanlinesPerRow, FillRule fillRule = FILL_NONZERO);
